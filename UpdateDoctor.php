...
<header id="header" class="header fixed-top d-flex align-items-center">
  ...
  <main id="main" class="main">
    ...
    <div class="card">
        <div class="card-body">
            <h5 class="card-title">Doctor Update Form</h5>

            <form class="row g-3" method="post">
                <?php
                $id = $_GET['id'];
                $con = mysqli_connect('localhost', 'root', '', 'Faaruuq');
                $sql1 = "SELECT * FROM doctors WHERE DoctorID = $id";
                ...
                <div class="col-6">
                    ...
                    <input type="text" class="form-control" id="doctorName" name="name" value="<?php echo $row['DoctorName']; ?>">
                </div>
                
                <div class="col-6">
                    <label for="doctorNumber" class="form-label">Doctor Number</label>
                    <input type="text" class="form-control" id="doctorNumber" name="number" value="<?php echo $row['DoctorNumber']; ?>">
                </div>
                
                <div class="col-6">
                    <label for="doctorService" class="form-label">Service</label>
                    <input type="text" class="form-control" id="doctorService" name="service" value="<?php echo $row['Service']; ?>">
                </div>
            ...
            if (isset($_POST['update'])) {
                ...
                $sql2 = "UPDATE doctors SET DoctorName = '$name', DoctorNumber = '$number', Service = '$service' WHERE DoctorID = $id";
                $result = mysqli_query($con, $sql2);

                if ($result) {
                    echo "<div class='alert alert-success'>Doctor updated successfully!</div>";
                } else {
                    echo "<div class='alert alert-danger'>Error updating doctor. Please try again.</div>";
                }
            }
            ?>
        </div>
