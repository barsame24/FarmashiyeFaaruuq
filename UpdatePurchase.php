...
<header id="header" class="header fixed-top d-flex align-items-center">
  ...
  <main id="main" class="main">
    ...
    <div class="card">
        <div class="card-body">
            <h5 class="card-title">Purchase Update Form</h5>

            <form class="row g-3" method="post">
                <?php
                $id = $_GET['id'];
                $con = mysqli_connect('localhost', 'root', '', 'Faaruuq');
                $sql1 = "SELECT * FROM purchases WHERE PurchaseID = $id";
                ...
                <div class="col-6">
                    ...
                    <input type="date" class="form-control" id="purchaseDate" name="purchase_date" value="<?php echo $row['PurchaseDate']; ?>">
                </div>
                ...
                <div class="col-6">
                    ...
                    <input type="number" step="0.01" class="form-control" id="cost" name="cost" value="<?php echo $row['Cost']; ?>">
                </div>
            ...
            if (isset($_POST['update'])) {
                ...
                $sql2 = "UPDATE purchases SET MedicineID = '$medicine_id', PurchaseDate = '$purchase_date', Quantity = '$quantity', Cost = '$cost' WHERE PurchaseID = $id";
                $result = mysqli_query($con, $sql2);

                if ($result) {
                    echo "<div class='alert alert-success'>Purchase updated successfully!</div>";
                } else {
                    echo "<div class='alert alert-danger'>Error updating purchase. Please try again.</div>";
                }
            }
            ?>
        </div>
