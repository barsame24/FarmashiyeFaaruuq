...
<header id="header" class="header fixed-top d-flex align-items-center">
  ...
  <main id="main" class="main">
    ...
    <div class="card">
        <div class="card-body">
            <h5 class="card-title">Sale Update Form</h5>

            <form class="row g-3" method="post">
                <?php
                $id = $_GET['id'];
                $con = mysqli_connect('localhost', 'root', '', 'Faaruuq');
                $sql1 = "SELECT * FROM sales WHERE SaleID = $id";
                ...
                <div class="col-6">
                    ...
                    <input type="text" class="form-control" id="medicineID" name="medicine_id" value="<?php echo $row['MedicineID']; ?>">
                </div>
                
                <div class="col-6">
                    <label for="doctorID" class="form-label">Doctor ID</label>
                    <input type="text" class="form-control" id="doctorID" name="doctor_id" value="<?php echo $row['DoctorID']; ?>">
                </div>
                
                <div class="col-6">
                    <label for="saleDate" class="form-label">Sale Date</label>
                    <input type="date" class="form-control" id="saleDate" name="sale_date" value="<?php echo $row['SaleDate']; ?>">
                </div>
                ...
                <div class="col-6">
                    ...
                    <input type="number" step="0.01" class="form-control" id="totalAmount" name="total_amount" value="<?php echo $row['TotalAmount']; ?>">
                </div>
                
                <div class="col-6">
                    <label for="paymentMethod" class="form-label">Payment Method</label>
                    <input type="text" class="form-control" id="paymentMethod" name="payment_method" value="<?php echo $row['PaymentMethod']; ?>">
                </div>
            ...
            if (isset($_POST['update'])) {
                ...
                $sql2 = "UPDATE sales SET MedicineID = '$medicine_id', DoctorID = '$doctor_id', SaleDate = '$sale_date', Quantity = '$quantity', TotalAmount = '$total_amount', PaymentMethod = '$payment_method' WHERE SaleID = $id";
                $result = mysqli_query($con, $sql2);

                if ($result) {
                    echo "<div class='alert alert-success'>Sale updated successfully!</div>";
                } else {
                    echo "<div class='alert alert-danger'>Error updating sale. Please try again.</div>";
                }
            }
            ?>
        </div>
