    ...
    <ul class="sidebar-nav" id="sidebar-nav">
      ...
      <li class="nav-item">
        ...
        <ul id="reports-nav" class="nav-content collapse show" data-bs-parent="#sidebar-nav">
          <li>
            <a href="SalesReports.php" class="active">
...
<div class="card">
  <div class="card-body">
    <h5 class="card-title">Sales Report Form</h5>
    ...
    if (isset($_POST['search'])) {
      ...
      $query = "SELECT Sales.*, medicines.Name FROM Sales JOIN medicines ON sales.MedicineID = medicines.MedicineID WHERE SaleDate >= '$from_date' AND SaleDate <= '$to_date'";
      $total_amount = "SELECT SUM(TotalAmount) AS TotalAmount FROM Sales WHERE SaleDate >= '$from_date' AND SaleDate <= '$to_date'"; 
      $result2 = mysqli_query($con, $total_amount);
    ?>
    <table class="table datatable">
      ...
      <tfoot>
        <tr>
          <td colspan="5" style="text-align: left; font-weight: bold; font-size: 18px;">Total Amount:</td>
          <td colspan="2" style="text-align: left; font-weight: bold; font-size: 18px;">
            $<?php while ($r = mysqli_fetch_array($result2)) { echo $r['TotalAmount']; } ?>
          </td>
        </tr>
      </tfoot>
    </table>
