...
<header id="header" class="header fixed-top d-flex align-items-center">
    ...
    <ul class="sidebar-nav" id="sidebar-nav">
      ...
      <li class="nav-item">
        ...
        <ul id="components-nav" class="nav-content collapse show" data-bs-parent="#sidebar-nav">
          <li>
            <a href="ListMedicines.php" class="active">
    ...
    <div class="pagetitle">
      ...
      <nav>
        <ol class="breadcrumb">
          ...
          <li class="breadcrumb-item">Medicines List</li>
        </ol>
      </nav>
    </div><!-- End Page Title -->
  ...
  <div class="row">
    <div class="col-lg-12">
      <div class="card">
        <div class="card-body">
          <h5 class="card-title">List of Medicines</h5>
          <!-- <p>This is the list of medicines available. We are using the <a href="https://github.com/fiduswriter/Simple-DataTables" target="_blank">Simple DataTables</a> library. Just add <code>.datatable</code> class name to any table you wish to convert to a datatable. Check for <a href="https://fiduswriter.github.io/simple-datatables/demos/" target="_blank">more examples</a>.</p> -->
          ...
          <table class="table datatable">
            ...
            <tbody>
              ...
              // Query to fetch medicines from the Medicines table
              ...
              if ($result = mysqli_query($con, $sql)) {
                if (mysqli_num_rows($result) > 0) {
                  ...
                  // Loop through each row in the Medicines table
                  while ($row = mysqli_fetch_array($result)) {
                    ...
                    <tr>
                      ...
                      <td>
                        <a href="UpdateMedicine.php?id=<?php echo $row['MedicineID']; ?>"><button type="button" class="btn btn-success">Update</button></a>
                        <a href="deleteMedicine.php?id=<?php echo $row['MedicineID']; ?>"><button type="button" class="btn btn-danger">Delete</button></a>
                      </td>
                    </tr>
                    <?php
                  }
