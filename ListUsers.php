    ...
    <ul class="sidebar-nav" id="sidebar-nav">
      ...
      <li class="nav-item">
        ...
        <ul id="users-nav" class="nav-content collapse show" data-bs-parent="#sidebar-nav">
          <li>
            <a href="ListUsers.php" class="active">
          ...
          <div class="card-body">
            ...
            <table class="table datatable">
              ...
              <tbody>
                ...
                // Query to fetch users from the Users table
                  ...
                  if (mysqli_num_rows($result) > 0) {
                    ...
                    while ($row = mysqli_fetch_array($result)) {
                      ...
                      <tr>
                        ...
                        <td>
                          <a href="updateUser.php?id=<?php echo $row['UserID']; ?>"><button type="button" class="btn btn-success">Update</button></a>
                          <a href="deleteUser.php?id=<?php echo $row['UserID']; ?>"><button type="button" class="btn btn-danger">Delete</button></a>
                        </td>
                      </tr>
                      <?php
                    }
