...
<header id="header" class="header fixed-top d-flex align-items-center">
  ...
  <aside id="sidebar" class="sidebar">
    ...
    <ul class="sidebar-nav" id="sidebar-nav">
      ...
      <!-- Medicines Section -->
      <li class="nav-item">
        <a class="nav-link" data-bs-target="#medicines-nav" data-bs-toggle="collapse" href="#">
          <i class="bi bi-journal-text"></i><span>Medicines</span><i class="bi bi-chevron-down ms-auto"></i>
        </a>
        <ul id="medicines-nav" class="nav-content collapse show" data-bs-parent="#sidebar-nav">
          <li>
          ...
          <li>
            <a href="AddMedicine.php" class="active">
...
<main id="main" class="main">
  ...
  <div class="card">
    <div class="card-body">
      <h5 class="card-title">Medicine Form</h5>
      ...
      if (isset($_POST['save'])) {
        ...
        $price = $_POST['price'];
        $created_at = date('Y-m-d H:i:s'); // Automatically set CreatedAt
        $updated_at = date('Y-m-d H:i:s'); // Automatically set UpdatedAt

        // Insert query to add new medicine (without Supplier)
        $sql = "INSERT INTO Medicines (Name, Price, CreatedAt, UpdatedAt) 
                VALUES ('$medicine_name', '$price', '$created_at', '$updated_at')";
        $result = mysqli_query($con, $sql);

        if ($result) {
          echo "<div class='alert alert-success'>Medicine added successfully!</div>";
        } else {
          echo "<div class='alert alert-danger'>Error! Could not save medicine.</div>";
        }
      }
