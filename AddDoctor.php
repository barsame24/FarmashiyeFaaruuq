...
<main id="main" class="main">
  ...
  <div class="card">
    <div class="card-body">
      <h5 class="card-title">Doctor Form</h5>
      ...
      <form class="row g-3" method="post">
        ...
        <div class="col-6">
          ...
          <input type="text" class="form-control" id="doctorNumber" name="doctor_number" required>
        </div>
      ...
      if (isset($_POST['save'])) {
        ...
        // Insert query to add a new doctor
        $sql = "INSERT INTO Doctors (DoctorName, DoctorNumber, Service) 
                VALUES ('$doctor_name', '$doctor_number', '$service')";
        $result = mysqli_query($con, $sql);

        if ($result) {
          echo "<div class='alert alert-success'>Doctor added successfully!</div>";
        } else {
          echo "<div class='alert alert-danger'>Error! Could not save doctor.</div>";
        }
      }
