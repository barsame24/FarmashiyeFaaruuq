    ...
    <ul class="sidebar-nav" id="sidebar-nav">
      ...
      <li class="nav-item">
        ...
        <ul id="sales-nav" class="nav-content collapse show" data-bs-parent="#sidebar-nav">
          ...
          <li>
            <a href="AddSale.php" class="active">
    ...
    <div class="card-body">
      ...
      <form class="row g-3" method="post">
        <div class="col-6">
          ...
          <select class="form-select" id="medicineID" name="medicine_id" required>
            ...
            $medicineResult = mysqli_query($con, $medicineQuery);
            ...
            // Close medicine result connection
            mysqli_free_result($medicineResult);
            ?>
          </select>
        </div>
      ...
      if (isset($_POST['save'])) {
        ...
        // Insert query to add a new sale
        $sql = "INSERT INTO Sales (MedicineID, SaleDate, Quantity, TotalAmount, PaymentMethod) 
                VALUES ('$medicine_id', '$sale_date', '$quantity', '$total_amount', '$payment_method')";
        $result = mysqli_query($con, $sql);

        if ($result) {
          echo "<div class='alert alert-success'>Sale added successfully!</div>";
        } else {
          echo "<div class='alert alert-danger'>Error! Could not save sale. " . mysqli_error($con) . "</div>";
        }
      }
