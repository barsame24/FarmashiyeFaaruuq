    ...
    <ul class="sidebar-nav" id="sidebar-nav">
      ...
      <li class="nav-item">
        ...
        <ul id="sales-nav" class="nav-content collapse show" data-bs-parent="#sidebar-nav">
          <li>
            <a href="ListSales.php" class="active">
                ...
                <div class="card-body">
                    ...
                    <table class="table datatable">
                        ...
                        <tbody>
                            ...
                            // Query to fetch sales with doctor and medicine names
                            $sql = "
                                SELECT 
                                    S.SaleID, 
                                ...
                                if (mysqli_num_rows($result) > 0) {
                                    ...
                                    while ($row = mysqli_fetch_array($result)) {
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <a href="updateSale.php?id=<?php echo $row['SaleID']; ?>"><button type="button" class="btn btn-success">Update</button></a>
                                                <a href="deleteSale.php?id=<?php echo $row['SaleID']; ?>"><button type="button" class="btn btn-danger">Delete</button></a>
                                            </td>
                                        </tr>
                                        <?php
                                    }
