    ...
    <ul class="sidebar-nav" id="sidebar-nav">
      ...
      <li class="nav-item">
        ...
        <ul id="purchases-nav" class="nav-content collapse show" data-bs-parent="#sidebar-nav">
          <li>
            <a href="ListPurchases.php" class="active">
  ...
  <section class="section">
    <div class="row">
      <div class="col-lg-12">
        <div class="card">
          <div class="card-body">
            <h5 class="card-title">List of Purchases</h5>
            ...
            <table class="table datatable">
              ...
              <tbody>
                ...
                // Query to fetch purchases from the Purchases table
                $sql = "SELECT purchases.*, medicines.Name FROM purchases JOIN medicines ON purchases.MedicineID = medicines.MedicineID";

                if ($result = mysqli_query($con, $sql)) {
                  if (mysqli_num_rows($result) > 0) {
                    // Loop through each row in the Purchases table
                    while ($row = mysqli_fetch_array($result)) {
                      ...
                      <tr>
                        ...
                        <td>
                          <a href="updatePurchase.php?id=<?php echo $row['PurchaseID']; ?>"><button type="button" class="btn btn-success">Update</button></a>
                          <a href="deletePurchase.php?id=<?php echo $row['PurchaseID']; ?>"><button type="button" class="btn btn-danger">Delete</button></a>
                        </td>
                      </tr>
                      <?php
                    }
